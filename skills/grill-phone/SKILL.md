...
description: >
  ...
  real code. Code snippets are sent to the terminal for user to examine and answer questions about them. Use when the user says "grill me on this code/file", "quiz me on
  <thing>", "test my understanding of <module>", or invokes /grill-phone. Optional
